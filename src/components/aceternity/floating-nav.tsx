        ...
        <AnimatePresence initial={false}>
          {!scrolled && (
            <motion.button
              ...
              exit={{ opacity: 0, width: 0 }}
              transition={{ duration: 0.15 }}
              className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/15 text-sm text-nav-text/80 hover:bg-white/15 hover:text-nav-text transition-colors shrink-0 cursor-pointer overflow-hidden whitespace-nowrap"
            >
