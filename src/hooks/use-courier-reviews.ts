...
import { fetchCourierReviews } from '@/lib/reviews'
...
export function useCourierReviews(courierId: string | undefined): State {
  ...
  useEffect(() => {
    ...
    fetchCourierReviews(courierId, sort, filterStar ?? undefined, page)
  ...
  }, [courierId, sort, filterStar, page])
