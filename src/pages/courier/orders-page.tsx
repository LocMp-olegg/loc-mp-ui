                ...
                {lat == null || lng == null ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      >
                        <RefreshCw className={cn('w-3 h-3', available.loading && 'animate-spin')} />
                        Обновить
                      </button>
                    </div>
              ...
              <>
                <div className="flex justify-end mb-4">
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer disabled:opacity-50"
                  >
                    <RefreshCw className={cn('w-3 h-3', myDeliveries.loading && 'animate-spin')} />
                    Обновить
                  </button>
                </div>
                ...
                {myDeliveries.loading ? (
                  ...
                  <p className="text-sm text-destructive text-center py-16">{myDeliveries.error}</p>
